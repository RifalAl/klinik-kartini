                        <div class=" my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
                            ...
                            <form id="form-cari" action="<?= base_url('Data') ?>" method="get" >
  ...
  <div class="page-body">
    <div class="container-xl">
      <div class="row row-deck row-cards">
        ...
        <!-- Check if $pesan is set, then display it -->
          <div id="data-container" class="row row-cards mt-1">
              ...
              <div class="card card-sm border-top-0 border-bottom-0 border-end-0 border-5   <?= $data->status == 'Aktif' ? 'border-success' : 'border-secondary' ?>">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                      <a href="<?=BASE_URL?>Data_pasien/index/<?=$data->nomor?>">
        ...
        function displayData(data) {
            ...
            $.each(data, function(index, item) {
                html += '<div class="col-sm-4">' +
                    ...
                    '<div class="row align-items-center">' +
                    '<div class="col">' +
                    '<a href="<?=BASE_URL?>Data_pasien/index/' + item.nomor + '">' +
